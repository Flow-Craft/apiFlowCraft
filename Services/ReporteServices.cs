...
namespace ApiNet8.Services
{
    public class ReporteServices : IReporteServices
    {
        ...
        public byte[] ReporteReservaUsuarioPeriodo(DateTime periodoInicio, DateTime periodoFin, int idUsuario)
        {
            // Crear el PDF en memoria
            using (var memoryStream = new MemoryStream())
            {
                ...
                // Título
                Paragraph title = new Paragraph("Reservas por usuario y periodo")
                    .SetTextAlignment(TextAlignment.CENTER)
                    .SetFontSize(18);
                document.Add(title);
                ...
                List<Reserva> reservasUsuario = _reservasServices.GetReservasByUsuarioPeriodo(idUsuario, periodoInicio, periodoFin);
